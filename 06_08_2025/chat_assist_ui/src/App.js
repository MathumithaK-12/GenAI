...
function App() {
  ...
  const [enteredViaPreChat, setEnteredViaPreChat] = useState(false);
    ...
    <div className={`app-container ${darkMode ? 'dark' : ''}`}>
      ...
      {!chatStarted ? (
        ...
        <div className="chat-wrapper">
          <ChatScreen onEndChat={handleEndChat} darkMode={darkMode} assistType={selectedAssist} autoInitiate={enteredViaPreChat} />
        </div>
      )}
    </div>
  );
