...
def ask_llm(prompt, system_prompt="You are a helpful IT support assistant at Warehousing area. Be natural and concise. Reduce ambiguity. Always address back or greet back only when it is greeting"):
